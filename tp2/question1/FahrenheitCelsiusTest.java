...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        assertEquals(-10f, question1.FahrenheitCelsius.fahrenheitEnCelsius(14));
        assertEquals(-17.7f, question1.FahrenheitCelsius.fahrenheitEnCelsius(0));
        assertEquals(60.0f, question1.FahrenheitCelsius.fahrenheitEnCelsius(140));
        assertEquals(37.7f, question1.FahrenheitCelsius.fahrenheitEnCelsius(100));
    }
