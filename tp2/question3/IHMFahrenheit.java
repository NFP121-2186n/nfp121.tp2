...
public class IHMFahrenheit extends JFrame implements ActionListener{
	  ...
	  public void actionPerformed( ActionEvent ae ){
	    try{
	      ...
	      if(celsius < -273.1) throw new AbsoluteZeroException("Error! C'est plus froid que le zero absolu!");
...
class AbsoluteZeroException extends Exception{  
	AbsoluteZeroException(String s){  
	  super(s);  
	 }  
	}  